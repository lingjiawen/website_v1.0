                        ...
                        <div className="row">
                            <div className="col-md-2 col-sm-4 col-xs-6">
                                <div className="app_box" onClick={this.handleOnclick}>
                                    <FaAtm height="6em" width="6em" className="chat_home_icon"/>
                                    <div className="chat_home">聊天室</div>
                                </div>
                            </div>
                            <div className="col-md-2 col-sm-4 col-xs-6">
                                <div className="app_box">
                                    <FaMail height="6em" width="6em"/>
                                </div>
                            </div>
                            <div className="col-md-2 col-sm-4 col-xs-6">
                                <div className="app_box">
                                    <FaAtm height="6em" width="6em"/>
                                </div>
                            </div>
                            <div className="col-md-2 col-sm-4 col-xs-6">
                                <div className="app_box">
                                    <FaResume height="6em" width="6em"/>
                                </div>
                            </div>
                            <div className="col-md-2 col-sm-4 col-xs-6">
                                <div className="app_box">
                                    <FaQq height="6em" width="6em"/>
                                </div>
                            </div>
                            <div className="col-md-2 col-sm-4 col-xs-6">
                                <div className="app_box">
